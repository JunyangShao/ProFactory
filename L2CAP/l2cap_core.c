...
//+++ProFactory tag
static int parse_msgL2(struct l2cap_conn* pconn, struct l2cap_chan* pchan, struct sk_buff* skb_in);
static int parse_msgL2Cmd(struct l2cap_conn* pconn, struct l2cap_chan* pchan, struct sk_buff* skb_in);
...
//		len = __le16_to_cpu(hdr->len) + L2CAP_HDR_SIZE;
        hdr = (struct l2Hdr_hdr *) skb->data;
		len = __le16_to_cpu(hdr->l2Len) + H_L2HDR_SIZE;
